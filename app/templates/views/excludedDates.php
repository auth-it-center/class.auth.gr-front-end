...
<div class="container-fluid">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			Τροποποιήθηακν τα στοιχεία της αργίας.
			</div>
  ...
  <div class="modal fade" id="deleteExcludedDateModal" role="dialog">
	...
	<div class="modal fade" id="helpModal" role="dialog">
 	...
 	{{ error_excludeddates }}
	<table id="users-table" class="table dataTable table-striped table-bordered table-panchara" st-table="datesList" st-safe-src="dates">
		<thead>
            <tr>
